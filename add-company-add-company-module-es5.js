...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["add-company-add-company-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppCompanyAddCompanyAddCompanyComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppCompanyAddCompanyAddCompanyComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_service_common_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    ...
    var AddCompanyComponent = /*#__PURE__*/function () {
      function AddCompanyComponent(router, activatedRoute, fb, dataService, commonService, companyService) {
      ...
      _createClass(AddCompanyComponent, [{
        ...
        value: function editObject() {
          ...
          this.companyService.getCompanyById(this.editId, {
            admin: true
        ...
        value: function submitForm() {
          ...
          if (this.companyForm.valid) {
            ...
            if (this.isEditing) {
              this.companyService.editCompany(this.editId, formData).subscribe(function (response) {
                _this2.showLoader = false;

                if (response.success) {
                  _this2.router.navigateByUrl('/company');
                } else {
                  _this2.showLoader = false;
                  response.error.map(function (obj) {
                    if (obj.hasOwnProperty('email')) {
                      _this2.formErrors.email = obj.email;
                    }

                    if (obj.hasOwnProperty('phone_number')) {
                      _this2.formErrors.phone_number = obj.phone_number;
                    }

                    if (!obj.hasOwnProperty('name') && !obj.hasOwnProperty('phone_number') && !obj.hasOwnProperty('email')) {
                      _this2.formErrors.apierror = obj;
                    }
                  });
                }
              });
            } else {
              this.companyService.addCompany(formData).subscribe(function (response) {
                _this2.showLoader = false;
                ...
                if (response.success) {
                  ...
                  response.error.map(function (obj) {
                    ...
                    if (!obj.hasOwnProperty('company_name') && !obj.hasOwnProperty('email') && !obj.hasOwnProperty('phone_number')) {
                      _this2.formErrors.apierror = obj;
                    }
                  });
                }
    ...
    AddCompanyComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-add-company',
      template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! raw-loader!./add-company.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/company/add-company/add-company.component.html"))["default"]
    })], AddCompanyComponent);
    /***/
  },
  ...
  /***/
  function srcAppCompanyAddCompanyAddCompanyModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
