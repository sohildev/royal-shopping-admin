...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PaymentDetailsListComponent", function() { return PaymentDetailsListComponent; });
...
/* harmony import */ var src_app_service_payment_details_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/service/payment-details.service */ "./src/app/service/payment-details.service.ts");
...
let PaymentDetailsListComponent = class PaymentDetailsListComponent {
    constructor(dataService, paymentDetailsservice, paginationService) {
    ...
    getObjects() {
        ...
        this.paymentDetailsservice.getPaymentDetailsList(params).subscribe((response) => {
    ...
    deleteObject(object) {
        swal.fire({
            ...
            if (result.value) {
                this.paymentDetailsservice.deletePaymentDetails(object.id).subscribe((response) => {
                    if (response.success) {
                        this.getObjects();
                    }
                });
...
PaymentDetailsListComponent.ctorParameters = () => [
...
PaymentDetailsListComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-payment-details-list',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./payment-details-list.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/payment-details/payment-details-list/payment-details-list.component.html")).default
    })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PaymentDetailsListModule", function() { return PaymentDetailsListModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
/* harmony import */ var _payment_details_list_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./payment-details-list.component */ "./src/app/payment-details/payment-details-list/payment-details-list.component.ts");
...
/* harmony import */ var src_app_service_payment_details_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/service/payment-details.service */ "./src/app/service/payment-details.service.ts");
...
let PaymentDetailsListModule = class PaymentDetailsListModule {
};
PaymentDetailsListModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            _payment_details_list_component__WEBPACK_IMPORTED_MODULE_4__["PaymentDetailsListComponent"]
        ],
        imports: [
        ...
        providers: [
            src_app_service_payment_details_service__WEBPACK_IMPORTED_MODULE_7__["PaymentDetailsService"]
        ]
    })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PaymentDetailsService", function() { return PaymentDetailsService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
let PaymentDetailsService = class PaymentDetailsService {
    ...
    getPaymentDetailsList(param) {
        return this.http.get(`${this.API_URL}/payment-details`, { params: param });
    }
    addPaymentDetails(data) {
        return this.http.post(`${this.API_URL}/payment-details`, data);
    }
    editPaymentDetails(id, data) {
        return this.http.put(`${this.API_URL}/payment-details/${id}`, data);
    }
    deletePaymentDetails(id) {
        return this.http.delete(`${this.API_URL}/payment-details/${id}`);
    }
    getPaymentDetailsById(id, param = null) {
        return this.http.get(`${this.API_URL}/payment-details/${id}`, { params: param });
    }
};
PaymentDetailsService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"] }
];
PaymentDetailsService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
//# sourceMappingURL=payment-details-payment-details-list-payment-details-list-module-es2015.js.map