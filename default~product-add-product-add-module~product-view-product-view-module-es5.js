...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~product-add-product-add-module~product-view-product-view-module"], {
  /***/
  ...
  /*! exports provided: NgxEditorComponent, NgxEditorModule, isListItem, isMarkActive, isNodeActive, marks, menu, nodes, placeholder, schema, toggleBlockType, toggleList, toggleWrap, ɵ0, ɵa, ɵb, ɵc */

  /***/
  function node_modulesNgxEditor__ivy_ngcc__Fesm2015NgxEditorJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "NgxEditorComponent", function () {
    ...
    __webpack_require__.d(__webpack_exports__, "isListItem", function () {
      return isListItem;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "isMarkActive", function () {
      return isMarkActive;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "isNodeActive", function () {
      return isNodeActive;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "marks", function () {
      return marks;
    });
    /* harmony export (binding) */
    ...
    __webpack_require__.d(__webpack_exports__, "nodes", function () {
      return nodes;
    });
    /* harmony export (binding) */
    ...
    __webpack_require__.d(__webpack_exports__, "toggleBlockType", function () {
      return toggleBlockType;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "toggleList", function () {
      return toggleList;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "toggleWrap", function () {
      return toggleWrap;
    });
    /* harmony export (binding) */
    ...
    __webpack_require__.d(__webpack_exports__, "ɵc", function () {
      return provideMyServiceOptions;
    });
    /* harmony import */
    ...
    /*! tslib */
    "./node_modules/ngx-editor/node_modules/tslib/tslib.es6.js");
    /* harmony import */
    ...
    var prosemirror_state__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! prosemirror-state */
    "./node_modules/prosemirror-state/dist/index.es.js");
    /* harmony import */


    var prosemirror_view__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! prosemirror-view */
    "./node_modules/prosemirror-view/dist/index.es.js");
    /* harmony import */


    var prosemirror_commands__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! prosemirror-commands */
    "./node_modules/prosemirror-commands/dist/index.es.js");
    /* harmony import */


    var prosemirror_schema_list__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! prosemirror-schema-list */
    "./node_modules/prosemirror-schema-list/dist/index.es.js");
    /* harmony import */


    var prosemirror_model__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! prosemirror-model */
    "./node_modules/prosemirror-model/dist/index.es.js");
    /* harmony import */


    var prosemirror_schema_basic__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! prosemirror-schema-basic */
    "./node_modules/prosemirror-schema-basic/dist/index.es.js");

    var _c0 = ["ngxEditor"];

    var isMarkActive = function isMarkActive(state, type) {
    ...
    var findNodeType = function findNodeType(type, $from) {
    ...
    var isNodeActive = function isNodeActive(state, type) {
    ...
    var isListItem = function isListItem(type, schema) {
      return type === schema.nodes.list_item || type === schema.nodes.ordered_list || type === schema.nodes.bullet_list;
    };
    ...
    var toggleBlockType = function toggleBlockType(type, toggleType) {
      ...
      return function (state, dispatch) {
        ...
        if (isActive) {
          return Object(prosemirror_commands__WEBPACK_IMPORTED_MODULE_5__["setBlockType"])(toggleType)(state, dispatch);
        }

        return Object(prosemirror_commands__WEBPACK_IMPORTED_MODULE_5__["setBlockType"])(type, attrs)(state, dispatch);
      };
    };
    ...
    var toggleList = function toggleList(type, itemType) {
      return function (state, dispatch) {
        ...
        if (isActive) {
          return Object(prosemirror_schema_list__WEBPACK_IMPORTED_MODULE_6__["liftListItem"])(itemType)(state, dispatch);
        }

        return Object(prosemirror_schema_list__WEBPACK_IMPORTED_MODULE_6__["wrapInList"])(type)(state, dispatch);
      };
    };
    ...
    var toggleWrap = function toggleWrap(type) {
      return function (state, dispatch) {
        ...
        if (isActive) {
          return Object(prosemirror_commands__WEBPACK_IMPORTED_MODULE_5__["lift"])(state, dispatch);
        }

        return Object(prosemirror_commands__WEBPACK_IMPORTED_MODULE_5__["wrapIn"])(type)(state, dispatch);
      };
    };
    /* tslint:disable */
    ...
    function getIconSvg(name) {
      var width = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : DEFAULT_ICON_WIDTH;
      var height = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : DEFAULT_ICON_HEIGHT;
    ...
    var ACTIVE_MENU_ITEM_CLASSNAME = "".concat(MENU_ITEM_CLASSNAME, "--Active");
    var DISABLED_CLASSNAME = 'NgxEditor--Disabled';
    var DROPDWON_ITEM_CLASSNAME = 'NgxEditor__Dropdown';
    var DROPWDOWN_OPEN_CLASSNAME = "".concat(DROPDWON_ITEM_CLASSNAME, "--Open");
    var ACTIVE_DROPDOWN_ITEM_CLASSNAME = "".concat(DROPDWON_ITEM_CLASSNAME, "--Active");
    var SELECTED_DROPDOWN_ITEM_CLASSNAME = "".concat(DROPDWON_ITEM_CLASSNAME, "--Selected");
    ...
    var DropDownView = /*#__PURE__*/function () {
      ...
      _createClass(DropDownView, [{
        ...
        value: function getWrapperDom() {
          ...
          dropdownText.classList.add("".concat(DROPDWON_ITEM_CLASSNAME, "__Text"));
          dropdownText.textContent = labels[this.dropdownGroup];
          dropdown.appendChild(dropdownText); // create dropdown list

          var dropdownMenu = document.createElement('div');
          dropdownMenu.classList.add("".concat(DROPDWON_ITEM_CLASSNAME, "__DropdownMenu"));
          ...
          this.dropdownFields.forEach(function (dropdownItem) {
            ...
            if (menuItem.key === 'heading') {
              text += " ".concat(menuItem.attrs.level);
            }

            var spec = {
              classNames: ["".concat(DROPDWON_ITEM_CLASSNAME, "__Item")],
              textContent: text,
              attrs: {
                title: text
              },
            ...
            var _menuItemView$render = menuItemView.render(),
                update = _menuItemView$render.update,
                dom = _menuItemView$render.dom; // remove open class once clicked on dropdown value
            ...
            var dropUpdate = function dropUpdate(state) {
              update(state); // update the dropdown content heading when a class is selected
    ...
    var MenuItemView = /*#__PURE__*/function () {
      ...
      _createClass(MenuItemView, [{
        ...
        value: function render() {
          ...
          var _this$setupCommandLis = this.setupCommandListeners(),
              command = _this$setupCommandLis.command;

          var _this$spec = this.spec,
              activeClass = _this$spec.activeClass,
              disabledClass = _this$spec.disabledClass;

          var update = function update(state) {
            var menuItem = _this2.menuItem;
            var isActive = false;
            var canExecute = command(_this2.editorView.state, null);
            ...
            if (menuItem.type === 'node') {
              var _type = schema.nodes[menuItem.key];
              isActive = isNodeActive(state, _type, menuItem.attrs);
            }
        ...
        key: "setupCommandListeners",
        value: function setupCommandListeners() {
          var _this3 = this;
          ...
          if (this.menuItem.type === 'mark') {
            command = Object(prosemirror_commands__WEBPACK_IMPORTED_MODULE_5__["toggleMark"])(schema.marks[this.menuItem.key]);
          }
          ...
          if (this.menuItem.type === 'node') {
            ...
            if (type === schema.nodes.heading) {
              command = toggleBlockType(type, schema.nodes.paragraph, {
                level: this.menuItem.attrs.level
              });
            }
          ...
          this.dom.addEventListener('mousedown', function (e) {
            e.preventDefault(); // don't execute if not left click
            ...
            command(_this3.editorView.state, _this3.editorView.dispatch);
          });
          return {
            command: command
          };
    ...
    var getSeperatorDom = function getSeperatorDom() {
      var div = document.createElement('div');
    ...
    var renderMenu = function renderMenu(options, editorView, menuDom) {
      var updates = [];
      ...
      toolbar.forEach(function (group, toolbarIndex) {
        ...
        group.forEach(function (toolbarItem, menuIndex) {
          var isLastMenuItem = group.length - 1 === menuIndex; // render dropdown
          ...
          if (typeof toolbarItem === 'string') {
            ...
            if (menuItem) {
              var spec = {
                classNames: [MENU_ITEM_CLASSNAME, "".concat(MENU_ITEM_CLASSNAME, "--Icon")],
              ...
              var _menuItemView$render2 = menuItemView.render(),
                  update = _menuItemView$render2.update,
                  dom = _menuItemView$render2.dom;
          ...
          if (typeof toolbarItem === 'function') {
            var _toolbarItem = toolbarItem(editorView),
                _dom = _toolbarItem.dom,
                _update = _toolbarItem.update;

            menuDom.appendChild(_dom);
    ...
    var MenuBarView = /*#__PURE__*/function () {
      ...
      _createClass(MenuBarView, [{
        ...
        value: function render() {
          ...
          var _renderMenu = renderMenu(this.options, this.view, menuDom),
              update = _renderMenu.update;
    ...
    var DEFAULT_TOOLBAR = [['bold', 'italic'], ['code', 'blockquote'], ['ordered_list', 'bullet_list'], [{
    ...
    function menuPlugin(options) {
      return new prosemirror_state__WEBPACK_IMPORTED_MODULE_3__["Plugin"]({
        key: new prosemirror_state__WEBPACK_IMPORTED_MODULE_3__["PluginKey"]('menu'),
    ...
    function placeholderPlugin() {
      var text = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : DEFAULT_PLACEHOLDER;
      return new prosemirror_state__WEBPACK_IMPORTED_MODULE_3__["Plugin"]({
        ...
        props: {
          decorations: function decorations(state) {
            ...
            if (doc.childCount === 1 && doc.firstChild.isTextblock && doc.firstChild.content.size === 0) {
              ...
              return prosemirror_view__WEBPACK_IMPORTED_MODULE_4__["DecorationSet"].create(doc, [prosemirror_view__WEBPACK_IMPORTED_MODULE_4__["Decoration"].widget(1, placeHolderEl)]);
            }
    ...
    var listGroup = 'block';
    var listItem = Object.assign({}, prosemirror_schema_list__WEBPACK_IMPORTED_MODULE_6__["listItem"], {
      content: 'paragraph block*'
    });
    var orderedList$1 = Object.assign({}, prosemirror_schema_list__WEBPACK_IMPORTED_MODULE_6__["orderedList"], {
      content: 'list_item+',
      group: listGroup
    });
    var bulletList$1 = Object.assign({}, prosemirror_schema_list__WEBPACK_IMPORTED_MODULE_6__["bulletList"], {
      content: 'list_item+',
      group: listGroup
    });
    var nodes = Object.assign({}, prosemirror_schema_basic__WEBPACK_IMPORTED_MODULE_8__["nodes"], {
      list_item: listItem,
      ordered_list: orderedList$1,
      bullet_list: bulletList$1
    });
    var marks = prosemirror_schema_basic__WEBPACK_IMPORTED_MODULE_8__["marks"];
    var schema = new prosemirror_model__WEBPACK_IMPORTED_MODULE_7__["Schema"]({
      marks: marks,
      nodes: nodes
    });

    var NgxEditorServiceConfig = function NgxEditorServiceConfig() {
      _classCallCheck(this, NgxEditorServiceConfig);

      this.plugins = [menu(), placeholderPlugin()];
      this.nodeViews = {};
      this.schema = schema;
    };
    ...
    NgxEditorServiceConfig.ɵprov = Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"])({
      factory: function NgxEditorServiceConfig_Factory() {
        return new NgxEditorServiceConfig();
      },
      token: NgxEditorServiceConfig,
      providedIn: "root"
    });

    var NgxEditorService = function NgxEditorService(config) {
      _classCallCheck(this, NgxEditorService);

      this.config = config;
    };

    NgxEditorService.ɵfac = function NgxEditorService_Factory(t) {
      return new (t || NgxEditorService)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](NgxEditorServiceConfig, 8));
    };

    NgxEditorService.ctorParameters = function () {
      return [{
    ...
    NgxEditorService.ɵprov = Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"])({
      factory: function NgxEditorService_Factory() {
        return new NgxEditorService(Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"])(NgxEditorServiceConfig, 8));
      },
      token: NgxEditorService,
      providedIn: "root"
    });
    NgxEditorService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__param"])(0, Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Optional"])())], NgxEditorService);
    var defaultConfig = {
      plugins: [],
      nodeViews: {},
      schema: schema
    ...
    var NgxEditorComponent = NgxEditorComponent_1 = /*#__PURE__*/function () {
      ...
      _createClass(NgxEditorComponent, [{
        ...
        key: "parseDoc",
        value: function parseDoc(contentJson) {
          if (!contentJson) {
            return null;
          }
        ...
        value: function updateContent(value) {
          try {
            ...
            var state = this.view.state; // don't emit if both content is same
        ...
        value: function handleTransactions(tr) {
          var _this$view$state$appl = this.view.state.applyTransaction(tr),
        ...
        value: function createEditor() {
          var _this$config = this.config,
              ...
              nodeViews = _this$config.nodeViews;
          this.view = new prosemirror_view__WEBPACK_IMPORTED_MODULE_4__["EditorView"](this.ngxEditor.nativeElement, {
    ...
    NgxEditorComponent.ɵfac = function NgxEditorComponent_Factory(t) {
      return new (t || NgxEditorComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](NgxEditorService));
    };

    NgxEditorComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
      ...
      viewQuery: function NgxEditorComponent_Query(rf, ctx) {
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵqueryRefresh"](_t = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵloadQuery"]()) && (ctx.ngxEditor = _t.first);
        }
      },
      features: [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵProvidersFeature"]([{
        provide: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["NG_VALUE_ACCESSOR"],
        useExisting: Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["forwardRef"])(function () {
          return NgxEditorComponent_1;
        }),
        multi: true
      }])],
      decls: 2,
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('ngxEditor', {
      "static": true
    })], NgxEditorComponent.prototype, "ngxEditor", void 0);
    var NgxEditorModule_1;
    var NGX_EDITOR_CONFIG_TOKEN = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["InjectionToken"]('NgxEditorConfig');

    var NgxEditorModule = NgxEditorModule_1 = /*#__PURE__*/function () {
      function NgxEditorModule() {
        _classCallCheck(this, NgxEditorModule);
      }

      _createClass(NgxEditorModule, null, [{
        key: "forRoot",
    ...
    NgxEditorModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineNgModule"]({
      type: NgxEditorModule
    });
    NgxEditorModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      factory: function NgxEditorModule_Factory(t) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](NgxEditorServiceConfig, [{
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](NgxEditorService, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"],
        args: [{
          providedIn: 'root'
        }]
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](NgxEditorComponent, [{
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](NgxEditorModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](NgxEditorModule, [{
  ...
  /***/
  function node_modulesNgxEditorNode_modulesTslibTslibEs6Js(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesOrderedmapIndexEsJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";

    __webpack_require__.r(__webpack_exports__); // ::- Persistent data structure representing an ordered mapping from
    ...
    __webpack_exports__["default"] = orderedmap;
    /***/
  },
  ...
  /***/
  function node_modulesProsemirrorCommandsDistIndexEsJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "autoJoin", function () {
      return autoJoin;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "baseKeymap", function () {
      return baseKeymap;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "chainCommands", function () {
      return chainCommands;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "createParagraphNear", function () {
      return createParagraphNear;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "deleteSelection", function () {
    ...
    __webpack_require__.d(__webpack_exports__, "joinBackward", function () {
      return joinBackward;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "joinDown", function () {
      return joinDown;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "joinForward", function () {
      return joinForward;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "joinUp", function () {
      return joinUp;
    });
    /* harmony export (binding) */
    ...
    __webpack_require__.d(__webpack_exports__, "liftEmptyBlock", function () {
      return liftEmptyBlock;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "macBaseKeymap", function () {
      return macBaseKeymap;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "newlineInCode", function () {
      return newlineInCode;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "pcBaseKeymap", function () {
      return pcBaseKeymap;
    });
    /* harmony export (binding) */
    ...
    __webpack_require__.d(__webpack_exports__, "selectNodeBackward", function () {
      return selectNodeBackward;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "selectNodeForward", function () {
      return selectNodeForward;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "selectParentNode", function () {
      return selectParentNode;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "setBlockType", function () {
      return setBlockType;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "splitBlock", function () {
      return splitBlock;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "splitBlockKeepMarks", function () {
      return splitBlockKeepMarks;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "toggleMark", function () {
      return toggleMark;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "wrapIn", function () {
      return wrapIn;
    });
    /* harmony import */
    ...
    var prosemirror_model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! prosemirror-model */
    "./node_modules/prosemirror-model/dist/index.es.js");
    /* harmony import */


    var prosemirror_state__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! prosemirror-state */
    "./node_modules/prosemirror-state/dist/index.es.js"); // :: (EditorState, ?(tr: Transaction)) → bool
    ...
    function splitBlock(state, dispatch) {
      ...
      if (dispatch) {
        ...
        if (state.selection instanceof prosemirror_state__WEBPACK_IMPORTED_MODULE_2__["TextSelection"]) {
          tr.deleteSelection();
        }
    ...
    var baseKeymap = mac ? macBaseKeymap : pcBaseKeymap; //# sourceMappingURL=index.es.js.map
  ...
  /***/
  function node_modulesProsemirrorModelDistIndexEsJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ContentMatch", function () {
      return ContentMatch;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "DOMParser", function () {
      return DOMParser;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "DOMSerializer", function () {
    ...
    __webpack_require__.d(__webpack_exports__, "NodeRange", function () {
      return NodeRange;
    });
    /* harmony export (binding) */
    ...
    __webpack_require__.d(__webpack_exports__, "ReplaceError", function () {
      return ReplaceError;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "ResolvedPos", function () {
      return ResolvedPos;
    });
    /* harmony export (binding) */
    ...
    var orderedmap__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
    /*! orderedmap */
    "./node_modules/orderedmap/index.es.js");
  ...
  /***/
  function node_modulesProsemirrorSchemaBasicDistIndexEsJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var prosemirror_model__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
    /*! prosemirror-model */
    "./node_modules/prosemirror-model/dist/index.es.js");
  ...
  /***/
  function node_modulesProsemirrorSchemaListDistIndexEsJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "addListNodes", function () {
      return addListNodes;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "bulletList", function () {
      return bulletList;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "liftListItem", function () {
      return liftListItem;
    });
    /* harmony export (binding) */
    ...
    __webpack_require__.d(__webpack_exports__, "sinkListItem", function () {
      return sinkListItem;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "splitListItem", function () {
      return splitListItem;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "wrapInList", function () {
      return wrapInList;
    });
    /* harmony import */
  ...
  /***/
  function node_modulesProsemirrorStateDistIndexEsJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AllSelection", function () {
      return AllSelection;
    });
    /* harmony export (binding) */
    ...
    var prosemirror_transform__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! prosemirror-transform */
    "./node_modules/prosemirror-transform/dist/index.es.js");
  ...
  /***/
  function node_modulesProsemirrorTransformDistIndexEsJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AddMarkStep", function () {
      return AddMarkStep;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "MapResult", function () {
      return MapResult;
    });
    /* harmony export (binding) */
    ...
    __webpack_require__.d(__webpack_exports__, "RemoveMarkStep", function () {
      return RemoveMarkStep;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "ReplaceAroundStep", function () {
      return ReplaceAroundStep;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "ReplaceStep", function () {
      return ReplaceStep;
    });
    /* harmony export (binding) */
    ...
    __webpack_require__.d(__webpack_exports__, "StepMap", function () {
      return StepMap;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "StepResult", function () {
      return StepResult;
    });
    /* harmony export (binding) */
    ...
    __webpack_require__.d(__webpack_exports__, "TransformError", function () {
      return TransformError;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "canJoin", function () {
      return canJoin;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "canSplit", function () {
      return canSplit;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "dropPoint", function () {
      return dropPoint;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "findWrapping", function () {
      return findWrapping;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "insertPoint", function () {
      return insertPoint;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "joinPoint", function () {
      return joinPoint;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "liftTarget", function () {
      return liftTarget;
    });
    /* harmony export (binding) */
    ...
    var prosemirror_model__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
    /*! prosemirror-model */
    "./node_modules/prosemirror-model/dist/index.es.js"); // Mappable:: interface
  ...
  /***/
  function node_modulesProsemirrorViewDistIndexEsJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var prosemirror_state__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
    /*! prosemirror-state */
    "./node_modules/prosemirror-state/dist/index.es.js");
    /* harmony import */
    ...
    var prosemirror_transform__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! prosemirror-transform */
    "./node_modules/prosemirror-transform/dist/index.es.js");
    ...
    editHandlers.drop = function (view, e) {
      ...
      if (view.someProp("handleDrop", function (f) {
        return f(view, e, slice || prosemirror_model__WEBPACK_IMPORTED_MODULE_1__["Slice"].empty, dragging && dragging.move);
      })) {
        e.preventDefault();
        return;
      }
...
//# sourceMappingURL=default~product-add-product-add-module~product-view-product-view-module-es5.js.map