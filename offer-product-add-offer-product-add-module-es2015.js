...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OfferProductAddComponent", function() { return OfferProductAddComponent; });
...
let OfferProductAddComponent = class OfferProductAddComponent {
    ...
    editObject() {
        ...
        this.ProductService.getOfferProductById(this.editId).subscribe((response) => {
            this.loadingState = false;
            if (response.data) {
    ...
    submitForm(formdata) {
        if (this.addForm.valid) {
            ...
            if (this.isEditing) {
                this.ProductService.editOfferProduct(this.editId, formdata.value).subscribe((response) => {
                    this.showLoader = false;
                    if (response.success) {
                        this.router.navigateByUrl('/bankinfo');
                    }
                ...
                this.ProductService.addOfferProduct(formdata.value).subscribe((response) => {
                    this.showLoader = false;
                    if (response.success) {
                        this.router.navigateByUrl('/bankinfo');
                    }
...
OfferProductAddComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] },
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
    { type: src_app_service_product_service__WEBPACK_IMPORTED_MODULE_4__["ProductService"] }
];
OfferProductAddComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-offer-product-add',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./offer-product-add.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/product/offer-product-add/offer-product-add.component.html")).default
    })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OfferProductAddModule", function() { return OfferProductAddModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
/* harmony import */ var _offer_product_add_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./offer-product-add.component */ "./src/app/product/offer-product-add/offer-product-add.component.ts");
...
let OfferProductAddModule = class OfferProductAddModule {
};
OfferProductAddModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            _offer_product_add_component__WEBPACK_IMPORTED_MODULE_7__["OfferProductAddComponent"]
        ],
        imports: [
...
//# sourceMappingURL=offer-product-add-offer-product-add-module-es2015.js.map