...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["feedback-feedback-list-feedback-list-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppFeedbackFeedbackListFeedbackListComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppFeedbackFeedbackListFeedbackListComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_service_feedback_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! src/app/service/feedback.service */
    "./src/app/service/feedback.service.ts");

    var FeedbackListComponent = /*#__PURE__*/function () {
      function FeedbackListComponent(dataService, feedbackservice, paginationService) {
      ...
      _createClass(FeedbackListComponent, [{
        ...
        value: function getObjects() {
          ...
          this.feedbackservice.getFeedbackList(params).subscribe(function (response) {
        ...
        value: function deleteObject(object) {
          ...
          swal.fire({
            ...
            if (result.value) {
              _this3.feedbackservice.deleteFeedback(object.id).subscribe(function (response) {
                if (response.success) {
                  _this3.getObjects();
                }
              });
    ...
    FeedbackListComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-feedback-list',
      template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! raw-loader!./feedback-list.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/feedback/feedback-list/feedback-list.component.html"))["default"]
  ...
  /***/
  function srcAppFeedbackFeedbackListFeedbackListModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "FeedbackListModule", function () {
      return FeedbackListModule;
    });
    /* harmony import */
    ...
    var src_app_common_loder_loder_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    ...
    var _feedback_list_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./feedback-list.component */
    "./src/app/feedback/feedback-list/feedback-list.component.ts");
    /* harmony import */


    var src_app_service_feedback_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! src/app/service/feedback.service */
    "./src/app/service/feedback.service.ts");
    ...
    var routes = [{
      ...
      loadChildren: function loadChildren() {
        return Promise.all(
        /*! import() | feedback-add-feedback-add-module */
        [__webpack_require__.e("default~add-company-add-company-module~auth-forgot-password-forgot-password-module~auth-login-login-~6bb3449d"), __webpack_require__.e("default~banner-add-banner-add-module~brand-brand-list-brand-list-module~cart-add-cart-add-module~cus~68433d59"), __webpack_require__.e("common"), __webpack_require__.e("feedback-add-feedback-add-module")]).then(__webpack_require__.bind(null,
        /*! ../feedback-add/feedback-add.module */
        "./src/app/feedback/feedback-add/feedback-add.module.ts")).then(function (m) {
          return m.FeedbackAddModule;
        });
      }
    }, {
      path: 'edit/:id',
    ...
    var FeedbackListModule = function FeedbackListModule() {
      _classCallCheck(this, FeedbackListModule);
    };

    FeedbackListModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [_feedback_list_component__WEBPACK_IMPORTED_MODULE_6__["FeedbackListComponent"]],
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], src_app_common_loder_loder_module__WEBPACK_IMPORTED_MODULE_4__["LoderModule"], src_app_common_pagination_pagination_module__WEBPACK_IMPORTED_MODULE_5__["PaginationModule"], // RatingModule ,
      _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forChild(routes)],
      providers: [src_app_service_feedback_service__WEBPACK_IMPORTED_MODULE_7__["FeedbackService"]]
    })], FeedbackListModule);
    /***/
  },
  ...
  /***/
  function srcAppServiceFeedbackServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var FeedbackService = /*#__PURE__*/function () {
      ...
      _createClass(FeedbackService, [{
        key: "getFeedbackList",
        value: function getFeedbackList(param) {
          return this.http.get("".concat(this.API_URL, "/feedback"), {
            params: param
          });
        }
      }, {
        key: "addFeedback",
        value: function addFeedback(data) {
          return this.http.post("".concat(this.API_URL, "/feedback"), data);
        }
      }, {
        key: "editFeedback",
        value: function editFeedback(id, data) {
          return this.http.put("".concat(this.API_URL, "/feedback/").concat(id), data);
        }
      }, {
        key: "deleteFeedback",
        value: function deleteFeedback(id) {
          return this.http["delete"]("".concat(this.API_URL, "/feedback/").concat(id));
        }
      }, {
        key: "getFeedbackById",
        value: function getFeedbackById(id) {
          var param = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
          return this.http.get("".concat(this.API_URL, "/feedback/").concat(id), {
            params: param
          });
        }
      }]);
    ...
    FeedbackService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Injectable"])()], FeedbackService);
    /***/
  }
}]);
//# sourceMappingURL=feedback-feedback-list-feedback-list-module-es5.js.map