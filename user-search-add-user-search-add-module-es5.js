...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["user-search-add-user-search-add-module"], {
  /***/
  "./node_modules/raw-loader/dist/cjs.js!./src/app/user-search/user-search-add/user-search-add.component.html":
  /*!******************************************************************************************************************!*\
    !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/user-search/user-search-add/user-search-add.component.html ***!
    \******************************************************************************************************************/
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppUserSearchUserSearchAddUserSearchAddComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  "./src/app/user-search/user-search-add/user-search-add.component.ts":
  /*!**************************************************************************!*\
    !*** ./src/app/user-search/user-search-add/user-search-add.component.ts ***!
    \**************************************************************************/

  /*! exports provided: UserSearchAddComponent */

  /***/
  function srcAppUserSearchUserSearchAddUserSearchAddComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "UserSearchAddComponent", function () {
      return UserSearchAddComponent;
    });
    /* harmony import */
    ...
    var src_app_service_user_search_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! src/app/service/user-search.service */
    "./src/app/service/user-search.service.ts");

    var UserSearchAddComponent = /*#__PURE__*/function () {
      function UserSearchAddComponent(router, activatedRoute, fb, UserSearchService) {
        _classCallCheck(this, UserSearchAddComponent);
        ...
        this.addForm = fb.group({
          search_text: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required])]
        });
      }

      _createClass(UserSearchAddComponent, [{
        key: "ngOnInit",
        ...
        value: function editObject() {
          ...
          this.UserSearchService.getUserSearchById(this.editId).subscribe(function (response) {
        ...
        value: function fileChangeEvent(fileInput) {
          ...
          if (!fileInput.target.files[0].search_text.match(reg)) {
        ...
        value: function submitForm(formdata) {
          ...
          if (this.addForm.valid) {
            ...
            if (this.isEditing) {
              this.UserSearchService.editUserSearch(this.editId, formdata.value).subscribe(function (response) {
                _this2.showLoader = false;

                if (response.success) {
                  _this2.router.navigateByUrl('/search');
                } else {
                  _this2.showLoader = false;
                  response.error.map(function (obj) {
                    if (obj.hasOwnProperty('search_text')) {
                      _this2.formErrors.search_text = obj.search_text;
                    }
                  });
                }
              });
            } else {
              this.UserSearchService.addUserSearch(formdata.value).subscribe(function (response) {
                _this2.showLoader = false;
    ...
    UserSearchAddComponent.ctorParameters = function () {
      return [{
        ...
        type: src_app_service_user_search_service__WEBPACK_IMPORTED_MODULE_4__["UserSearchService"]
      }];
    };

    UserSearchAddComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-user-search-add',
      template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! raw-loader!./user-search-add.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/user-search/user-search-add/user-search-add.component.html"))["default"]
    })], UserSearchAddComponent);
    /***/
  },

  /***/
  "./src/app/user-search/user-search-add/user-search-add.module.ts":
  /*!***********************************************************************!*\
    !*** ./src/app/user-search/user-search-add/user-search-add.module.ts ***!
    \***********************************************************************/

  /*! exports provided: UserSearchAddModule */

  /***/
  function srcAppUserSearchUserSearchAddUserSearchAddModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "UserSearchAddModule", function () {
      return UserSearchAddModule;
    });
    /* harmony import */
    ...
    var _user_search_add_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./user-search-add.component */
    "./src/app/user-search/user-search-add/user-search-add.component.ts");

    var routes = [{
      path: '',
      component: _user_search_add_component__WEBPACK_IMPORTED_MODULE_8__["UserSearchAddComponent"]
    }];

    var UserSearchAddModule = function UserSearchAddModule() {
      _classCallCheck(this, UserSearchAddModule);
    };

    UserSearchAddModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [_user_search_add_component__WEBPACK_IMPORTED_MODULE_8__["UserSearchAddComponent"]],
...
//# sourceMappingURL=user-search-add-user-search-add-module-es5.js.map