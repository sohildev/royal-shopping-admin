...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["offer-product-add-offer-product-add-module"], {
  /***/
  "./node_modules/raw-loader/dist/cjs.js!./src/app/product/offer-product-add/offer-product-add.component.html":
  /*!******************************************************************************************************************!*\
    !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/product/offer-product-add/offer-product-add.component.html ***!
    \******************************************************************************************************************/
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppProductOfferProductAddOfferProductAddComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppProductOfferProductAddOfferProductAddComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_require__.d(__webpack_exports__, "OfferProductAddComponent", function () {
      return OfferProductAddComponent;
    });
    /* harmony import */
    ...
    var OfferProductAddComponent = /*#__PURE__*/function () {
      function OfferProductAddComponent(router, activatedRoute, fb, ProductService) {
        _classCallCheck(this, OfferProductAddComponent);
        ...
        this.addForm = fb.group({
          ...
          offer_price: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required])],
          vendors_offers_id: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required])]
        });
      }

      _createClass(OfferProductAddComponent, [{
        key: "ngOnInit",
        ...
        value: function editObject() {
          ...
          this.ProductService.getOfferProductById(this.editId).subscribe(function (response) {
            ...
            if (response.data) {
              _this.editImageUrl = response.data.image, _this.addForm.patchValue({
                ...
                vendors_offers_id: response.data.vendors_offers_id
              });
            }
          }, function (error) {
            _this.loadingState = false;
        ...
        value: function submitForm(formdata) {
          ...
          if (this.addForm.valid) {
            ...
            if (this.isEditing) {
              this.ProductService.editOfferProduct(this.editId, formdata.value).subscribe(function (response) {
              ...
              this.ProductService.addOfferProduct(formdata.value).subscribe(function (response) {
                _this2.showLoader = false;
    ...
    OfferProductAddComponent.ctorParameters = function () {
      return [{
    ...
    OfferProductAddComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-offer-product-add',
      template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! raw-loader!./offer-product-add.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/product/offer-product-add/offer-product-add.component.html"))["default"]
    })], OfferProductAddComponent);
    /***/
  },

  /***/
  "./src/app/product/offer-product-add/offer-product-add.module.ts":
  /*!***********************************************************************!*\
    !*** ./src/app/product/offer-product-add/offer-product-add.module.ts ***!
    \***********************************************************************/

  /*! exports provided: OfferProductAddModule */

  /***/
  function srcAppProductOfferProductAddOfferProductAddModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "OfferProductAddModule", function () {
      return OfferProductAddModule;
    });
    /* harmony import */
    ...
    var _offer_product_add_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./offer-product-add.component */
    "./src/app/product/offer-product-add/offer-product-add.component.ts");
    /* harmony import */
    ...
    var routes = [{
      path: '',
      component: _offer_product_add_component__WEBPACK_IMPORTED_MODULE_7__["OfferProductAddComponent"]
    }];

    var OfferProductAddModule = function OfferProductAddModule() {
      _classCallCheck(this, OfferProductAddModule);
    };

    OfferProductAddModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [_offer_product_add_component__WEBPACK_IMPORTED_MODULE_7__["OfferProductAddComponent"]],
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ng_select_ng_select__WEBPACK_IMPORTED_MODULE_8__["NgSelectModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"].forChild(routes), src_app_shared_form_validation_form_validation_module__WEBPACK_IMPORTED_MODULE_5__["FormValidationModule"], src_app_shared_shared_module__WEBPACK_IMPORTED_MODULE_6__["SharedModule"], src_app_common_loder_loder_module__WEBPACK_IMPORTED_MODULE_9__["LoderModule"]]
    })], OfferProductAddModule);
    /***/
  },
...
//# sourceMappingURL=offer-product-add-offer-product-add-module-es5.js.map