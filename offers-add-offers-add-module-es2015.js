...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OffersAddComponent", function() { return OffersAddComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/__ivy_ngcc__/fesm2015/forms.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
/* harmony import */ var src_app_service_offers_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/service/offers.service */ "./src/app/service/offers.service.ts");





let OffersAddComponent = class OffersAddComponent {
    constructor(router, activatedRoute, fb, offersservice) {
        this.router = router;
    ...
    editObject() {
        ...
        this.offersservice.getOffersById(this.editId).subscribe((response) => {
            this.loadingState = false;
            if (response.data) {
                this.editImageUrl = response.data.offer_image,
    ...
    submitForm(formdata) {
        if (this.addForm.valid) {
            ...
            if (this.isEditing) {
                this.offersservice.editOffers(this.editId, formData).subscribe((response) => {
                    this.showLoader = false;
                    if (response.success) {
                        this.router.navigateByUrl('/offer');
                    }
                        ...
                        response.error.map(obj => {
                            if (obj.hasOwnProperty('offer_name')) {
                                this.formErrors.offer_name = obj.offer_name;
                            }
                        });
                    }
                });
                ...
                this.offersservice.addOffers(formData).subscribe((response) => {
                    this.showLoader = false;
                    if (response.success) {
                        this.router.navigateByUrl('/offer');
                    }
...
OffersAddComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] },
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
    { type: src_app_service_offers_service__WEBPACK_IMPORTED_MODULE_4__["OffersService"] }
];
OffersAddComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-offers-add',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./offers-add.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/offers/offers-add/offers-add.component.html")).default
    })
], OffersAddComponent);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OffersAddModule", function() { return OffersAddModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/__ivy_ngcc__/fesm2015/forms.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
/* harmony import */ var _offers_add_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./offers-add.component */ "./src/app/offers/offers-add/offers-add.component.ts");
...
let OffersAddModule = class OffersAddModule {
};
OffersAddModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            _offers_add_component__WEBPACK_IMPORTED_MODULE_5__["OffersAddComponent"]
        ],
        imports: [
...
//# sourceMappingURL=offers-add-offers-add-module-es2015.js.map