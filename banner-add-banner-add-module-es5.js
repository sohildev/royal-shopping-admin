...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["banner-add-banner-add-module"], {
  /***/
  "./node_modules/raw-loader/dist/cjs.js!./src/app/banner/banner-add/banner-add.component.html":
  /*!***************************************************************************************************!*\
    !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/banner/banner-add/banner-add.component.html ***!
    \***************************************************************************************************/
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppBannerBannerAddBannerAddComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppBannerBannerAddBannerAddComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "BannerAddComponent", function () {
    ...
    var src_app_service_banner_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! src/app/service/banner.service */
    "./src/app/service/banner.service.ts");

    var BannerAddComponent = /*#__PURE__*/function () {
      function BannerAddComponent(router, activatedRoute, fb, bannerservice) {
        _classCallCheck(this, BannerAddComponent);
        ...
        this.addForm = fb.group({
          title: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required])],
          url: [null, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required])],
          info: [''],
      ...
      _createClass(BannerAddComponent, [{
        key: "ngOnInit",
        ...
        value: function editObject() {
          ...
          this.bannerservice.getBannerById(this.editId).subscribe(function (response) {
            ...
            _this.router.navigateByUrl('banner');
          });
        }
      }, {
        key: "fileChangeEvent",
        ...
        value: function submitForm(formdata) {
          ...
          if (this.addForm.valid) {
            ...
            formData.append('url', formdata.value.url);
            formData.append('title', formdata.value.title);
            formData.append('info', formdata.value.info);
            ...
            if (this.isEditing) {
              this.bannerservice.editBanner(this.editId, formData).subscribe(function (response) {
                _this2.showLoader = false;

                if (response.success) {
                  _this2.router.navigateByUrl('banner');
                } else {
                  _this2.showLoader = false;
                  response.error.map(function (obj) {
                    if (obj.hasOwnProperty('title')) {
                      _this2.formErrors.title = obj.title;
                    }
                  });
                }
              });
            } else {
              this.bannerservice.addBanner(formData).subscribe(function (response) {
                _this2.showLoader = false;
    ...
    BannerAddComponent.ctorParameters = function () {
      return [{
        ...
        type: src_app_service_banner_service__WEBPACK_IMPORTED_MODULE_4__["BannerService"]
      }];
    };

    BannerAddComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-banner-add',
      template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! raw-loader!./banner-add.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/banner/banner-add/banner-add.component.html"))["default"]
    })], BannerAddComponent);
    /***/
  },

  /***/
  "./src/app/banner/banner-add/banner-add.module.ts":
  /*!********************************************************!*\
    !*** ./src/app/banner/banner-add/banner-add.module.ts ***!
    \********************************************************/

  /*! exports provided: BannerAddModule */

  /***/
  function srcAppBannerBannerAddBannerAddModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "BannerAddModule", function () {
      return BannerAddModule;
    });
    /* harmony import */
    ...
    var _banner_add_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    ...
    var routes = [{
      path: '',
      component: _banner_add_component__WEBPACK_IMPORTED_MODULE_5__["BannerAddComponent"]
    }];

    var BannerAddModule = function BannerAddModule() {
      _classCallCheck(this, BannerAddModule);
    };

    BannerAddModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [_banner_add_component__WEBPACK_IMPORTED_MODULE_5__["BannerAddComponent"]],
...
//# sourceMappingURL=banner-add-banner-add-module-es5.js.map