...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["product-add-product-add-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppProductProductAddProductAddComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppProductProductAddProductAddComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var ProductAddComponent = /*#__PURE__*/function () {
      function ProductAddComponent(router, activatedRoute, fb, location, dropdownService, productService) {
      ...
      _createClass(ProductAddComponent, [{
        ...
        key: "getBrandList",
        value: function getBrandList(front) {
          var _this2 = this;
          ...
          this.dropdownService.getBrandDrp(params).subscribe(function (res) {
            ...
            if (res.success) {
              _this2.brandList = res.data ? res.data : [];
            }
          });
        }
      }, {
        ...
        value: function editObject() {
          ...
          this.productService.getProductById(this.editId).subscribe(function (response) {
            ...
            if (response.data) {
              _this3.editImageUrl = response.data.image, _this3.addForm.patchValue({
              ...
              _this3.getBrandList(false);
            }
          }, function (error) {
            _this3.loadingState = false; // this.router.navigateByUrl('/product');
        ...
        value: function submitForm(formdata) {
          ...
          if (this.addForm.valid) {
            ...
            if (this.isEditing) {
              this.productService.editProduct(this.editId, formData).subscribe(function (response) {
                ...
                if (response.success) {
                  ...
                  response.error.map(function (obj) {
                    if (obj.hasOwnProperty('name')) {
                      _this4.formErrors.name = obj.name;
                    }
                  });
                }
              });
    ...
    ProductAddComponent.ctorParameters = function () {
      return [{
    ...
    ProductAddComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-product-add',
      template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! raw-loader!./product-add.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/product/product-add/product-add.component.html"))["default"]
    })], ProductAddComponent);
    /***/
  },
  ...
  /***/
  function srcAppProductProductAddProductAddModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ProductAddModule", function () {
    ...
    var _product_add_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    ...
    var ngx_editor__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ngx-editor */
