...
/* harmony import */ var src_app_service_banner_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/service/banner.service */ "./src/app/service/banner.service.ts");





let BannerAddComponent = class BannerAddComponent {
    constructor(router, activatedRoute, fb, bannerservice) {
        this.router = router;
    ...
    editObject() {
        ...
        this.bannerservice.getBannerById(this.editId).subscribe((response) => {
            this.loadingState = false;
            if (response.data) {
    ...
    submitForm(formdata) {
        if (this.addForm.valid) {
            ...
            if (this.isEditing) {
                this.bannerservice.editBanner(this.editId, formData).subscribe((response) => {
                    this.showLoader = false;
                    if (response.success) {
                        this.router.navigateByUrl('banner');
                    }
                ...
                this.bannerservice.addBanner(formData).subscribe((response) => {
                    this.showLoader = false;
                    if (response.success) {
                        this.router.navigateByUrl('banner');
                    }
...
BannerAddComponent.ctorParameters = () => [
...
BannerAddComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./banner-add.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/banner/banner-add/banner-add.component.html")).default
    })
], BannerAddComponent);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BannerAddModule", function() { return BannerAddModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/__ivy_ngcc__/fesm2015/forms.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
/* harmony import */ var _banner_add_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./banner-add.component */ "./src/app/banner/banner-add/banner-add.component.ts");
...
let BannerAddModule = class BannerAddModule {
};
BannerAddModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            _banner_add_component__WEBPACK_IMPORTED_MODULE_5__["BannerAddComponent"]
        ],
        imports: [
...
//# sourceMappingURL=banner-add-banner-add-module-es2015.js.map