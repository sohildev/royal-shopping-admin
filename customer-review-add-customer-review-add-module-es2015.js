...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CustomerReviewAddComponent", function() { return CustomerReviewAddComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/__ivy_ngcc__/fesm2015/forms.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
/* harmony import */ var src_app_service_customer_review_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/service/customer-review.service */ "./src/app/service/customer-review.service.ts");





let CustomerReviewAddComponent = class CustomerReviewAddComponent {
    constructor(router, activatedRoute, fb, customerreviewService) {
        this.router = router;
    ...
    editObject() {
        ...
        this.customerreviewService.getCustomerReviewById(this.editId).subscribe((response) => {
            this.loadingState = false;
            if (response.data) {
    ...
    submitForm(formdata) {
        if (this.addForm.valid) {
            ...
            if (this.isEditing) {
                this.customerreviewService.editCustomerReview(this.editId, formdata.value).subscribe((response) => {
                    this.showLoader = false;
                    if (response.success) {
                        this.router.navigateByUrl('/customer-review');
                    }
                ...
                this.customerreviewService.addCustomerReview(formdata.value).subscribe((response) => {
                    this.showLoader = false;
                    if (response.success) {
                        this.router.navigateByUrl('/customer-review');
                    }
...
CustomerReviewAddComponent.ctorParameters = () => [
...
CustomerReviewAddComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-customer-review-add',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./customer-review-add.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/customer-review/customer-review-add/customer-review-add.component.html")).default,
    })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CustomerReviewAddModule", function() { return CustomerReviewAddModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
/* harmony import */ var _customer_review_add_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./customer-review-add.component */ "./src/app/customer-review/customer-review-add/customer-review-add.component.ts");
...
let CustomerReviewAddModule = class CustomerReviewAddModule {
};
CustomerReviewAddModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            _customer_review_add_component__WEBPACK_IMPORTED_MODULE_8__["CustomerReviewAddComponent"]
        ],
        imports: [
...
//# sourceMappingURL=customer-review-add-customer-review-add-module-es2015.js.map