...
/* harmony import */ var src_app_service_offers_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/service/offers.service */ "./src/app/service/offers.service.ts");
...
let OffersListComponent = class OffersListComponent {
    constructor(router, dataService, offersservice, paginationService) {
        this.router = router;
    ...
    getObjects() {
        ...
        this.offersservice.getOffersList(params).subscribe((response) => {
    ...
    deleteObject(object) {
        swal.fire({
            ...
            if (result.value) {
                this.offersservice.deleteOffers(object.id).subscribe((response) => {
                    if (response.success) {
                        this.getObjects();
                    }
                });
...
OffersListComponent.ctorParameters = () => [
...
OffersListComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-offers-list',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./offers-list.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/offers/offers-list/offers-list.component.html")).default
    })
], OffersListComponent);
...
/* harmony import */ var _offers_list_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./offers-list.component */ "./src/app/offers/offers-list/offers-list.component.ts");
...
/* harmony import */ var src_app_service_offers_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/service/offers.service */ "./src/app/service/offers.service.ts");
...
const routes = [
    ...
    {
        path: 'add',
        loadChildren: () => Promise.all(/*! import() | offers-add-offers-add-module */[__webpack_require__.e("default~add-company-add-company-module~auth-forgot-password-forgot-password-module~auth-login-login-~6bb3449d"), __webpack_require__.e("default~banner-add-banner-add-module~brand-brand-list-brand-list-module~cart-add-cart-add-module~cus~68433d59"), __webpack_require__.e("common"), __webpack_require__.e("offers-add-offers-add-module")]).then(__webpack_require__.bind(null, /*! ../offers-add/offers-add.module */ "./src/app/offers/offers-add/offers-add.module.ts")).then(m => m.OffersAddModule),
    },
    {
        path: 'edit/:id',
        loadChildren: () => Promise.all(/*! import() | offers-add-offers-add-module */[__webpack_require__.e("default~add-company-add-company-module~auth-forgot-password-forgot-password-module~auth-login-login-~6bb3449d"), __webpack_require__.e("default~banner-add-banner-add-module~brand-brand-list-brand-list-module~cart-add-cart-add-module~cus~68433d59"), __webpack_require__.e("common"), __webpack_require__.e("offers-add-offers-add-module")]).then(__webpack_require__.bind(null, /*! ../offers-add/offers-add.module */ "./src/app/offers/offers-add/offers-add.module.ts")).then(m => m.OffersAddModule),
...
let OffersListModule = class OffersListModule {
};
OffersListModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            _offers_list_component__WEBPACK_IMPORTED_MODULE_4__["OffersListComponent"]
        ],
        imports: [
        ...
        providers: [
            src_app_service_offers_service__WEBPACK_IMPORTED_MODULE_7__["OffersService"]
        ]
    })
], OffersListModule);
...
let OffersService = class OffersService {
    ...
    getOffersList(param) {
        return this.http.get(`${this.API_URL}/vendor-offers`, { params: param });
    }
    addOffers(data) {
        return this.http.post(`${this.API_URL}/vendor-offers`, data);
    }
    editOffers(id, data) {
        return this.http.put(`${this.API_URL}/vendor-offers/${id}`, data);
    }
    deleteOffers(id) {
        return this.http.delete(`${this.API_URL}/vendor-offers/${id}`);
    }
    getOffersById(id, param = null) {
        return this.http.get(`${this.API_URL}/vendor-offers/${id}`, { params: param });
    }
};
...
//# sourceMappingURL=offers-offers-list-offers-list-module-es2015.js.map