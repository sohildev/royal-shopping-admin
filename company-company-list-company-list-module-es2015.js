...
/* harmony import */ var src_app_service_company_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/service/company.service */ "./src/app/service/company.service.ts");
...
let CompanyListComponent = class CompanyListComponent {
    constructor(router, companyService, commonService, dataService, paginationService) {
        this.router = router;
    ...
    deleteObject(object) {
        swal.fire({
            ...
            if (result.value) {
                this.companyService.deleteCompany(object.id).subscribe((response) => {
                    if (response.success) {
                        this.getObjects();
                    }
                });
...
CompanyListComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./company-list.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/company/company-list/company-list.component.html")).default
    })
...
/* harmony import */ var _company_list_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./company-list.component */ "./src/app/company/company-list/company-list.component.ts");
...
const routes = [
    ...
    {
        path: 'add',
        loadChildren: () => Promise.all(/*! import() | add-company-add-company-module */[__webpack_require__.e("default~add-company-add-company-module~auth-forgot-password-forgot-password-module~auth-login-login-~6bb3449d"), __webpack_require__.e("common"), __webpack_require__.e("add-company-add-company-module")]).then(__webpack_require__.bind(null, /*! ../add-company/add-company.module */ "./src/app/company/add-company/add-company.module.ts")).then(m => m.AddCompanyModule),
...
CompanyListModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            _company_list_component__WEBPACK_IMPORTED_MODULE_4__["CompanyListComponent"]
        ],
        imports: [
        ...
        providers: [
            src_app_service_company_service__WEBPACK_IMPORTED_MODULE_5__["CompanyService"]
        ]
    })
], CompanyListModule);
...
//# sourceMappingURL=company-company-list-company-list-module-es2015.js.map